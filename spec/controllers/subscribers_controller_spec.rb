...
describe SubscribersController do
  ...
  let(:valid_attributes) { { "email" => "MyString", "password" => "p", "password_confirmation" => "p"} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscriber" do
        ...
        Subscriber.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => subscriber.to_param, :subscriber => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subscriber as @subscriber" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subscriber.any_instance.stub(:save).and_return(false)
        put :update, {:id => subscriber.to_param, :subscriber => { "email" => "invalid value" }}, valid_session
        assigns(:subscriber).should eq(subscriber)
      end
