...
describe ChargesController do
  ...
  let(:valid_attributes) { { "paid_status" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved charge as @charge" do
        ...
        post :create, {:charge => { "paid_status" => "invalid value" }}, valid_session
        assigns(:charge).should be_a_new(Charge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested charge" do
        ...
        Charge.any_instance.should_receive(:update).with({ "paid_status" => "MyString" })
        put :update, {:id => charge.to_param, :charge => { "paid_status" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the charge as @charge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Charge.any_instance.stub(:save).and_return(false)
        put :update, {:id => charge.to_param, :charge => { "paid_status" => "invalid value" }}, valid_session
        assigns(:charge).should eq(charge)
      end
